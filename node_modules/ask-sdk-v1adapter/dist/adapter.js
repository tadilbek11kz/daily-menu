...
function EmitEvent() {
    ...
    (_a = ask_sdk_1.SkillBuilders.custom()).addRequestHandlers.apply(_a, [new handler_1.Handler(this)].concat(this.v2RequestHandlers)).addRequestInterceptors(new copySessionAttributesInterceptor_1.CopySessionAttributesInterceptor())
